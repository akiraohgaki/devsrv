...
await Playground.test('example', async (t) => {
  ...
  await t.step('the preview content should be logged', () => {
    ...
    <script type="module">
      var a=class{#t;constructor(){this.#t=document.querySelector('[data-content="code"] code')}get(){return this.#t.textContent??""}set(t){this.#t.textContent=t}clear(){this.#t.textContent=""}async run(){let t=this.#t.textContent??"",e=URL.createObjectURL(new Blob([t],{type:"text/javascript"}));try{await import(e)}catch(n){console.error(n)}}};var c=class{#t;constructor(){this.#t=document.querySelector('[data-content="preview"]')}get(t){return t?this.#t.querySelector(t):this.#t}set(t){let e=document.createElement("template");if(typeof t=="string")e.innerHTML=t;else if(t instanceof Node)e.content.appendChild(t);else if(t instanceof NodeList)for(let n of Array.from(t))e.content.appendChild(n);else e.textContent=""+t;this.#t.textContent="",this.#t.appendChild(e.content)}clear(){this.#t.textContent=""}};var s=class{#t;constructor(){this.#t=document.querySelector('[data-content="logs"]')}get(){let t=this.#t.querySelectorAll('[data-content="log"]');return Array.from(t).map(e=>e.textContent??"")}add(...t){console.log(...t);let e=t.map(o=>o instanceof Error?o.message:Array.isArray(o)||typeof o=="object"&&o!==null?JSON.stringify(o):""+o).join(" "),n=document.createElement("pre");n.setAttribute("data-content","log"),n.textContent=e,this.#t.appendChild(n)}clear(){this.#t.textContent=""}};var l=new s,d=class i{#t;#e;constructor(t){this.#t={name:"Untitled test",fn:()=>{},parent:this,...t},this.#e={name:this.#t.name,passed:!1,result:void 0,exception:void 0,children:[]},this.#t.parent!==this&&this.#t.parent.state.children.push(this.#e)}get state(){return this.#e}async run(){let t={step:async(e,n)=>await new i({name:e,fn:n,parent:this}).run()};return await Promise.resolve().then(()=>this.#t.fn(t)).then(e=>{this.#e.passed=this.#o(),this.#e.result=e}).catch(e=>{this.#e.passed=!1,this.#e.exception=e}),this.#t.parent===this&&this.#n(this.#e),this.#e.passed}#o(){for(let t of this.#e.children)if(!t.passed)return!1;return!0}#n(t,e=1){l.add("#".repeat(e),t.name,"...",t.passed?"Passed":"Failed"),t.result!==void 0&&l.add("Result:",t.result),t.exception!==void 0&&l.add("Exception:",t.exception);for(let n of t.children)this.#n(n,e+1)}};var p=new a,h=new c,u=new s,r=class{static get code(){return p}static get preview(){return h}static get logs(){return u}static log(...t){u.add(...t)}static async test(t,e){return await new d({name:t,fn:e}).run()}static async sleep(t){await new Promise(e=>{setTimeout(e,t)})}};document.querySelector('[data-action="code.run"]')?.addEventListener("click",async()=>{await r.code.run()});document.querySelector('[data-action="code.clear"]')?.addEventListener("click",()=>{r.code.clear()});document.querySelector('[data-action="preview.clear"]')?.addEventListener("click",()=>{r.preview.clear()});document.querySelector('[data-action="logs.clear"]')?.addEventListener("click",()=>{r.logs.clear()});globalThis.Playground=r;
